...
public class BinarySearchTree<E extends Comparable<E>>
     ...
     * @param localRoot The root of the next subtree
    ...
    /**
     * This iterator is traverse ascending order on binary search tree
     *
     * @return ascending order iterator for binary search tree
     */
    public Iterator getAscendingOrderIterator() {
        return new AscendingOrderIterator();
    }

    /**
     * Iterator class Traverse ascending order for binary search tree
     */
    private class AscendingOrderIterator implements Iterator<E> {

        private Node<E> next;
        private Node<E> lastReturned;
        private Stack<Node> nodeStack = new Stack<>();

        public AscendingOrderIterator() {
            next = (Node<E>) root;
            lastReturned = null;
